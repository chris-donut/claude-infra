...
echo "  bash scripts/worktree/task-queue.sh add \"Task description\" --priority high"
echo ""
echo "  # Launch a single worker:"
echo "  bash scripts/worktree/launch-worker.sh 1"
echo ""
echo "  # Start the orchestrator (manages all workers):"
echo "  python3 scripts/worktree/orchestrator.py"
echo ""
echo "  # Or the legacy bash version:"
echo "  bash scripts/worktree/orchestrator.sh"
echo ""
echo "  # Check status:"
echo "  bash scripts/worktree/task-queue.sh status"
echo ""
echo "  # Tear down everything:"
echo "  bash scripts/worktree/teardown.sh"
